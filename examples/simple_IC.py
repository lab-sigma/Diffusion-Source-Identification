...
from diffusion_source.infection_model_randomized import save_model, FixedTSI_IW, ICM, LTM
from diffusion_source.discrepancies import L2_h, L2_after, ADiT_h, ADT_h, Z_minus, L2, loss_creator
...
I = ICM(G, losses, canonical=False, m=2000, T=-1)
K = 100
A = [0, 0]
B = [0, 0]
AB = [0, 0, 0, 0]
