...
def display_AxI(G, active, inactive, node_labels, layout, edge_labels, i=0):
    ...
    plt.savefig("spread_figures/ICspread_{}.pdf".format(i))
    plt.show()
...
display_AxI(G, {2}, {1}, labels, layout, edge_labels, 2)

edge_labels[(2, 4)] = ""
edge_labels[(4, 5)] = ""
edge_labels[(2, 5)] = ""

display_AxI(G, {4, 5}, {1, 2}, labels, layout, edge_labels, 3)

edge_labels[(3, 4)] = ""

display_AxI(G, {}, {1, 2, 4, 5}, labels, layout, edge_labels, 4)
